...
.input-field.is-invalid input.select-dropdown.dropdown-trigger {
  border-bottom: 1px solid #ba2525;
  box-shadow: 0 1px 0 0 #ba2525;
  color: #ba2525;
}
...
ul.dropdown-content.select-dropdown span {
...
export default {
  ...
  mounted() {
    ...
    // console.log(elems)
    // const hello = M.Modal.init(elems)
    M.AutoInit()
  }
}
</script>
